  ...
  <div class="prompt-edit">
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <el-button v-if="isEdit" type="success" :loading="publishing" @click="handlePublish">
          发布
        </el-button>
      </div>
    </div>
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" @submit.prevent>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="返回值" prop="return_type">
              <el-select v-model="form.return_type" placeholder="请选择返回值" style="width: 100%">
                <el-option
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="启用Mock">
              <el-switch v-model="form.mock" active-text="启用" inactive-text="禁用" />
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :span="12">
            <el-form-item label="模型" prop="model">
              ...
              <el-text
                ...
                style="margin-top: 4px; display: block"
              >
                当前提供商没有支持 {{ form.type || 'text' }} 输入 →
                {{ form.return_type || 'text' }} 输出的模型
              </el-text>
              <el-text
                v-else-if="
                  (form.type && form.type !== 'text') ||
                  (form.return_type && form.return_type !== 'text')
                "
                type="info"
                size="small"
                style="margin-top: 4px; display: block"
              >
                仅显示支持 {{ form.type || 'text' }} 输入 →
                {{ form.return_type || 'text' }} 输出的模型
              </el-text>
            </el-form-item>
          </el-col>
        ...
        <el-form-item label="模板" prop="template">
          ...
          <div style="margin-top: 8px; display: flex; justify-content: flex-end; gap: 8px">
            ...
            <el-button type="primary" size="small" plain @click="openInAIAssistant">
    ...
    const rules = {
      ...
      name: [
        ...
        { max: 255, message: '唯一标识长度不能超过255个字符', trigger: 'blur' },
        {
          ...
          message: '唯一标识必须以字母开头，只能包含字母、数字和下划线',
          trigger: 'blur'
        }
      ],
      type: [{ required: true, message: '请选择Prompt类型', trigger: 'change' }],
      model: [
        { required: true, message: '请输入模型名称', trigger: 'blur' },
        { max: 255, message: '模型名称长度不能超过255个字符', trigger: 'blur' }
      ],
      ai_provider: [{ required: true, message: '请选择AI提供商', trigger: 'change' }],
      return_type: [{ required: true, message: '请选择返回类型', trigger: 'change' }],
      format_type: [{ required: true, message: '请选择格式化类型', trigger: 'change' }],
